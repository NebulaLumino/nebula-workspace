      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Enter study design parameters (e.g., two-group comparison, expected effect size 0.5, alpha=0.05)..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Calculate Power"}
          </button>
        </div>
        {output && (
