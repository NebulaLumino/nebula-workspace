      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Enter sample type and research objective for EM preparation guidance..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Guide EM Prep"}
          </button>
        </div>
        {output && (
