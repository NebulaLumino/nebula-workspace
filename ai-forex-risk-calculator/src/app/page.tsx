    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 text-white p-6">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2 text-teal-400">Forex Risk Calculator</h1>
          <p className="text-slate-400 text-lg">Calculate forex position size, stop-loss, and profit targets</p>
        </div>
