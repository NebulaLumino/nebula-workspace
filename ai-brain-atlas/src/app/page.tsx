...
export default function Home() {
  ...
  const bgColor = "hsl(265deg,55%,50%)";
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Enter a brain region or structure name to query the atlas..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Query Atlas"}
          </button>
        </div>
        {output && (
