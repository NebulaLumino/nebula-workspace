...
export default function Home() {
  ...
  const bgColor = "hsl(235deg,55%,55%)";
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Enter assay type and target antigen/antibody for ELISA optimization..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Optimize ELISA"}
          </button>
        </div>
        {output && (
