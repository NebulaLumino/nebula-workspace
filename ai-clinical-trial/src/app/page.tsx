...
export default function Home() {
  ...
  const bgColor = "hsl(220deg,60%,55%)";
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Enter a research question or disease target for trial design (e.g., anti-PD1 efficacy in NSCLC)..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Design Clinical Trial"}
          </button>
        </div>
        {output && (
