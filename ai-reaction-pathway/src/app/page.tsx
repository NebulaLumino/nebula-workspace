      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Enter a target molecule or reaction goal (e.g., synthesize ibuprofen from isobutylbenzene...)..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Plan Synthesis"}
          </button>
        </div>
        {output && (
