...
export default function Home() {
  ...
  const bgColor = "hsl(215deg,45%,55%)";
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Paste your grant abstract or specific aims for pre-submission critique..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Critique Grant"}
          </button>
        </div>
        {output && (
