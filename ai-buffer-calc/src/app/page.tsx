...
export default function Home() {
  ...
  const bgColor = "hsl(175deg,55%,45%)";
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Enter target pH, buffer species, and concentration (e.g., phosphate buffer pH 7.4, 100mM)..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Calculate Buffer"}
          </button>
        </div>
        {output && (
