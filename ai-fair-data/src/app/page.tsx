...
export default function Home() {
  ...
  const bgColor = "hsl(340deg,55%,55%)";
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-6 mb-6 backdrop-blur-sm">
          ...
          <textarea
            ...
            rows={6}
            placeholder={"Describe your research project for FAIR data management guidance..."}
            value={input}
          ...
          >
            {loading ? "Processing..." : "Advise FAIR Data"}
          </button>
        </div>
        {output && (
